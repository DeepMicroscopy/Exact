...
urlpatterns = [
    ...
    re_path(r'^users/api/(?P<user_id>\d+)/impersonate/$', views.user_impersonate_api, name='user_impersonate_api'),
    re_path(r'^users/stop-impersonating/$', views.user_stop_impersonating, name='stop_impersonating'),
